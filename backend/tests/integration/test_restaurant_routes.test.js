...
// ✅ Fake auth middleware for ALL tests
// Pretend the restaurant is already authenticated.
...
describe('Restaurant Routes (Authenticated) - End-to-End Tests', () => {
  ...
  // ❗ IMPORTANT:
  // Do NOT use resetAllMocks() here.
  // That erases authenticateRestaurant.mockImplementation, which causes requests to hang.
  afterEach(() => {
    jest.clearAllMocks(); // keeps implementations, just clears call history
  });
